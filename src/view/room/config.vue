			...
			<div class="plugin">
				<el-row>
					...
					<el-tabs v-model='activeName2' type='card'>
						<el-tab-pane style='text-align:center;' label='桌面直播工具下载' name='first'>
							<el-button @click='downloadwin' style='border-radius:2rem;' type='primary'>windows版</el-button>
						</el-tab-pane>
						<el-tab-pane label='手机直播工具下载' name='second'>
...
<script>
	...
	export default {
		...
		mounted() {
			this.init();
			this.showStatus_common.origin=true
		}
	}
</script>
